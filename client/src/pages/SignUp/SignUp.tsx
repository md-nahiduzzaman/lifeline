     ...
     mx-auto bg-gradient-to-r from-[#ffffe4] to-[#ccff99dc] min-h-[75vh]">
        <div className='w-[95%] flex p-3 flex-col lg:flex-row justify-between items-center rounded-3xl min-h-[64vh] bg-[#333333ee]'>
          ...
          <div className='hov mt-5 p-2 lg:mt-[1px] w-full flex justify-center items-center lg:w-[44%] rounded-3xl'>
                      <div className=''>
                          <h1 className='text-3xl text-center font-medium mt-5 md:mt-[1px] mb-5'>Register</h1>
                          <form action="" className=''>
                             <input type="text" placeholder='Your Name' className='block p-1 mb-3 w-[330px] h-[45px] bg-gray-300
                             rounded-xl' name="" id="" />
                             
                             <input type="text" placeholder='Photo Url' className='block p-1 mb-3 w-[330px] h-[45px] bg-gray-300
                             rounded-xl' name="" id="" />  
                                 <input type="text" placeholder='Password' className='block p-1 mb-3 w-[330px] h-[45px] bg-gray-300
                             rounded-xl' name="" id="" />
                          </form>
